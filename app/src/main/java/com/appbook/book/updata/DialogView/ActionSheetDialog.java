package com.appbook.book.updata.DialogView;
...
import com.appbook.book.updata.Service.DownLoadService;
import com.appbook.book.updata.Utils.MD5;
...
public class ActionSheetDialog implements View.OnClickListener ,CallBack {
    ...
    public void Top(){
        ...
        params.put("id", str.getId());
        HttpUtils.post(context,MyRunApplication.getURL("/Book/updata/AddappClick.do"),params);
    }
    public ActionSheetDialog(Context context,UpdataInfo info ){
        ...
        path = context.getExternalFilesDir(null).getPath()+"/update_"+str.getAppvar()+".apk";
	}
    ...
    public void InitView(){
        version.setText(version.getText().toString()+str.getAppvarname());
        size.setText(size.getText().toString()+str.getAppsize());
        time.setText(time.getText().toString()+InitTime(str.getAppupdatatime()));
        content.setText(str.getState());
        title.setText(str.getAppname());
    }
    ...
    private boolean Isexist(){
        ...
        try {
            ...
            if(md5.equalsIgnoreCase(str.getAppmd5())){
                return true;
            }
            file.delete();
            return false;
    ...
    private void loadFile() {
        ...
        new Thread(){
            @Override
            public void run() {
                downLoadFile(str.getDowurl(),destFileDir,destFileName+"_"+str.getAppvar()+".apk");
            }
        }.start();
    }
    @Override
